...
//{E569FF03-5555-4029-B50B-B698E5ADBCF6}
static const IID IID_IExtendedAttribute = { 0xE569FF03, 0x5555, 0x4029, { 0xB5, 0x0B, 0xB6, 0x98, 0xE5, 0xAD, 0xBC, 0xF6} };

//{03A023AC-77E6-4DAF-A1C5-36D4FB831E69}
IMPLEMENT_OLECREATE_FLAGS(ExtendedAttribute, "MSP2010.ExtendedAttribute", afxRegApartmentThreading, 0x03A023AC, 0x77E6, 0x4DAF, 0xA1, 0xC5, 0x36, 0xD4, 0xFB, 0x83, 0x1E, 0x69)
...
DISP_PROPERTY_EX_ID(ExtendedAttribute, "sSecondaryGuid", 13, odl_GetSecondaryGuid, odl_SetSecondaryGuid, VT_BSTR)
DISP_PROPERTY_EX_ID(ExtendedAttribute, "sPhoneticAlias", 14, odl_GetPhoneticAlias, odl_SetPhoneticAlias, VT_BSTR)
DISP_PROPERTY_EX_ID(ExtendedAttribute, "yRollupType", 15, odl_GetRollupType, odl_SetRollupType, VT_I4)
DISP_PROPERTY_EX_ID(ExtendedAttribute, "yCalculationType", 16, odl_GetCalculationType, odl_SetCalculationType, VT_I4)
DISP_PROPERTY_EX_ID(ExtendedAttribute, "sFormula", 17, odl_GetFormula, odl_SetFormula, VT_BSTR)
DISP_PROPERTY_EX_ID(ExtendedAttribute, "bRestrictValues", 18, odl_GetRestrictValues, odl_SetRestrictValues, VT_BOOL)
DISP_PROPERTY_EX_ID(ExtendedAttribute, "yValuelistSortOrder", 19, odl_GetValuelistSortOrder, odl_SetValuelistSortOrder, VT_I4)
DISP_PROPERTY_EX_ID(ExtendedAttribute, "bAppendNewValues", 20, odl_GetAppendNewValues, odl_SetAppendNewValues, VT_BOOL)
DISP_PROPERTY_EX_ID(ExtendedAttribute, "sDefault", 21, odl_GetDefault, odl_SetDefault, VT_BSTR)
DISP_PROPERTY_EX_ID(ExtendedAttribute, "oValueList", 22, odl_GetValueList, SetNotSupported, VT_DISPATCH)
DISP_PROPERTY_EX_ID(ExtendedAttribute, "Key", 23, odl_GetKey, odl_SetKey, VT_BSTR)
DISP_FUNCTION_ID(ExtendedAttribute, "GetXML", 24, odl_GetXML, VT_BSTR, VTS_NONE)
DISP_FUNCTION_ID(ExtendedAttribute, "SetXML", 25, odl_SetXML, VT_EMPTY, VTS_BSTR)
DISP_FUNCTION_ID(ExtendedAttribute, "IsNull", 26, IsNull, VT_BOOL, VTS_NONE)
DISP_FUNCTION_ID(ExtendedAttribute, "Initialize", 27, Initialize, VT_EMPTY, VTS_NONE)
END_DISPATCH_MAP()
...
BSTR ExtendedAttribute::odl_GetSecondaryGuid(void)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	return GetSecondaryGuid().AllocSysString();
}

CString ExtendedAttribute::GetSecondaryGuid(void)
{
	return (CString) mp_sSecondaryGuid;
}

void ExtendedAttribute::odl_SetSecondaryGuid(LPCTSTR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	SetSecondaryGuid(newVal);
}

void ExtendedAttribute::SetSecondaryGuid(CString newVal)
{
	mp_sSecondaryGuid = newVal;
}
