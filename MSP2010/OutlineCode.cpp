...
//{8E58B255-80F9-422A-B22E-A4104C8E8020}
static const IID IID_IOutlineCode = { 0x8E58B255, 0x80F9, 0x422A, { 0xB2, 0x2E, 0xA4, 0x10, 0x4C, 0x8E, 0x80, 0x20} };

//{E5B759D7-4286-40BF-9D5D-A1E7A1778F27}
IMPLEMENT_OLECREATE_FLAGS(OutlineCode, "MSP2010.OutlineCode", afxRegApartmentThreading, 0xE5B759D7, 0x4286, 0x40BF, 0x9D, 0x5D, 0xA1, 0xE7, 0xA1, 0x77, 0x8F, 0x27)
...
DISP_PROPERTY_EX_ID(OutlineCode, "bShowIndent", 13, odl_GetShowIndent, odl_SetShowIndent, VT_BOOL)
DISP_PROPERTY_EX_ID(OutlineCode, "oMasks", 14, odl_GetMasks, SetNotSupported, VT_DISPATCH)
DISP_PROPERTY_EX_ID(OutlineCode, "Key", 15, odl_GetKey, odl_SetKey, VT_BSTR)
DISP_FUNCTION_ID(OutlineCode, "GetXML", 16, odl_GetXML, VT_BSTR, VTS_NONE)
DISP_FUNCTION_ID(OutlineCode, "SetXML", 17, odl_SetXML, VT_EMPTY, VTS_BSTR)
DISP_FUNCTION_ID(OutlineCode, "IsNull", 18, IsNull, VT_BOOL, VTS_NONE)
DISP_FUNCTION_ID(OutlineCode, "Initialize", 19, Initialize, VT_EMPTY, VTS_NONE)
END_DISPATCH_MAP()
...
BOOL OutlineCode::odl_GetShowIndent(void)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	return GetShowIndent();
}

BOOL OutlineCode::GetShowIndent(void)
{
	return (BOOL) mp_bShowIndent;
}

void OutlineCode::odl_SetShowIndent(BOOL newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	SetShowIndent((BOOL)newVal);
}

void OutlineCode::SetShowIndent(BOOL newVal)
{
	mp_bShowIndent = newVal;
}
