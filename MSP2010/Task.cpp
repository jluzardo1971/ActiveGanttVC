...
//{7D93462B-7EF6-4162-BA0C-87CB6A36BB35}
static const IID IID_ITask = { 0x7D93462B, 0x7EF6, 0x4162, { 0xBA, 0x0C, 0x87, 0xCB, 0x6A, 0x36, 0xBB, 0x35} };

//{B260D306-18A4-4D53-960B-583FED5C37FC}
IMPLEMENT_OLECREATE_FLAGS(Task, "MSP2010.Task", afxRegApartmentThreading, 0xB260D306, 0x18A4, 0x4D53, 0x96, 0x0B, 0x58, 0x3F, 0xED, 0x5C, 0x37, 0xFC)
...
DISP_PROPERTY_EX_ID(Task, "bDisplayAsSummary", 27, odl_GetDisplayAsSummary, odl_SetDisplayAsSummary, VT_BOOL)
DISP_PROPERTY_EX_ID(Task, "bCritical", 28, odl_GetCritical, odl_SetCritical, VT_BOOL)
DISP_PROPERTY_EX_ID(Task, "bIsSubproject", 29, odl_GetIsSubproject, odl_SetIsSubproject, VT_BOOL)
DISP_PROPERTY_EX_ID(Task, "bIsSubprojectReadOnly", 30, odl_GetIsSubprojectReadOnly, odl_SetIsSubprojectReadOnly, VT_BOOL)
DISP_PROPERTY_EX_ID(Task, "sSubprojectName", 31, odl_GetSubprojectName, odl_SetSubprojectName, VT_BSTR)
DISP_PROPERTY_EX_ID(Task, "bExternalTask", 32, odl_GetExternalTask, odl_SetExternalTask, VT_BOOL)
DISP_PROPERTY_EX_ID(Task, "sExternalTaskProject", 33, odl_GetExternalTaskProject, odl_SetExternalTaskProject, VT_BSTR)
DISP_PROPERTY_EX_ID(Task, "dtEarlyStart", 34, odl_GetEarlyStart, odl_SetEarlyStart, VT_DATE)
DISP_PROPERTY_EX_ID(Task, "dtEarlyFinish", 35, odl_GetEarlyFinish, odl_SetEarlyFinish, VT_DATE)
DISP_PROPERTY_EX_ID(Task, "dtLateStart", 36, odl_GetLateStart, odl_SetLateStart, VT_DATE)
DISP_PROPERTY_EX_ID(Task, "dtLateFinish", 37, odl_GetLateFinish, odl_SetLateFinish, VT_DATE)
DISP_PROPERTY_EX_ID(Task, "lStartVariance", 38, odl_GetStartVariance, odl_SetStartVariance, VT_I4)
DISP_PROPERTY_EX_ID(Task, "lFinishVariance", 39, odl_GetFinishVariance, odl_SetFinishVariance, VT_I4)
DISP_PROPERTY_EX_ID(Task, "fWorkVariance", 40, odl_GetWorkVariance, odl_SetWorkVariance, VT_R4)
DISP_PROPERTY_EX_ID(Task, "lFreeSlack", 41, odl_GetFreeSlack, odl_SetFreeSlack, VT_I4)
DISP_PROPERTY_EX_ID(Task, "lStartSlack", 42, odl_GetStartSlack, odl_SetStartSlack, VT_I4)
DISP_PROPERTY_EX_ID(Task, "lFinishSlack", 43, odl_GetFinishSlack, odl_SetFinishSlack, VT_I4)
DISP_PROPERTY_EX_ID(Task, "lTotalSlack", 44, odl_GetTotalSlack, odl_SetTotalSlack, VT_I4)
DISP_PROPERTY_EX_ID(Task, "fFixedCost", 45, odl_GetFixedCost, odl_SetFixedCost, VT_R4)
DISP_PROPERTY_EX_ID(Task, "yFixedCostAccrual", 46, odl_GetFixedCostAccrual, odl_SetFixedCostAccrual, VT_I4)
DISP_PROPERTY_EX_ID(Task, "lPercentComplete", 47, odl_GetPercentComplete, odl_SetPercentComplete, VT_I4)
DISP_PROPERTY_EX_ID(Task, "lPercentWorkComplete", 48, odl_GetPercentWorkComplete, odl_SetPercentWorkComplete, VT_I4)
DISP_PROPERTY_EX_ID(Task, "cCost", 49, odl_GetCost, odl_SetCost, VT_R8)
DISP_PROPERTY_EX_ID(Task, "cOvertimeCost", 50, odl_GetOvertimeCost, odl_SetOvertimeCost, VT_R8)
DISP_PROPERTY_EX_ID(Task, "oOvertimeWork", 51, odl_GetOvertimeWork, SetNotSupported, VT_DISPATCH)
DISP_PROPERTY_EX_ID(Task, "dtActualStart", 52, odl_GetActualStart, odl_SetActualStart, VT_DATE)
DISP_PROPERTY_EX_ID(Task, "dtActualFinish", 53, odl_GetActualFinish, odl_SetActualFinish, VT_DATE)
DISP_PROPERTY_EX_ID(Task, "oActualDuration", 54, odl_GetActualDuration, SetNotSupported, VT_DISPATCH)
DISP_PROPERTY_EX_ID(Task, "cActualCost", 55, odl_GetActualCost, odl_SetActualCost, VT_R8)
DISP_PROPERTY_EX_ID(Task, "cActualOvertimeCost", 56, odl_GetActualOvertimeCost, odl_SetActualOvertimeCost, VT_R8)
DISP_PROPERTY_EX_ID(Task, "oActualWork", 57, odl_GetActualWork, SetNotSupported, VT_DISPATCH)
DISP_PROPERTY_EX_ID(Task, "oActualOvertimeWork", 58, odl_GetActualOvertimeWork, SetNotSupported, VT_DISPATCH)
DISP_PROPERTY_EX_ID(Task, "oRegularWork", 59, odl_GetRegularWork, SetNotSupported, VT_DISPATCH)
DISP_PROPERTY_EX_ID(Task, "oRemainingDuration", 60, odl_GetRemainingDuration, SetNotSupported, VT_DISPATCH)
DISP_PROPERTY_EX_ID(Task, "cRemainingCost", 61, odl_GetRemainingCost, odl_SetRemainingCost, VT_R8)
DISP_PROPERTY_EX_ID(Task, "oRemainingWork", 62, odl_GetRemainingWork, SetNotSupported, VT_DISPATCH)
DISP_PROPERTY_EX_ID(Task, "cRemainingOvertimeCost", 63, odl_GetRemainingOvertimeCost, odl_SetRemainingOvertimeCost, VT_R8)
DISP_PROPERTY_EX_ID(Task, "oRemainingOvertimeWork", 64, odl_GetRemainingOvertimeWork, SetNotSupported, VT_DISPATCH)
DISP_PROPERTY_EX_ID(Task, "fACWP", 65, odl_GetACWP, odl_SetACWP, VT_R4)
DISP_PROPERTY_EX_ID(Task, "fCV", 66, odl_GetCV, odl_SetCV, VT_R4)
DISP_PROPERTY_EX_ID(Task, "yConstraintType", 67, odl_GetConstraintType, odl_SetConstraintType, VT_I4)
DISP_PROPERTY_EX_ID(Task, "lCalendarUID", 68, odl_GetCalendarUID, odl_SetCalendarUID, VT_I4)
DISP_PROPERTY_EX_ID(Task, "dtConstraintDate", 69, odl_GetConstraintDate, odl_SetConstraintDate, VT_DATE)
DISP_PROPERTY_EX_ID(Task, "dtDeadline", 70, odl_GetDeadline, odl_SetDeadline, VT_DATE)
DISP_PROPERTY_EX_ID(Task, "bLevelAssignments", 71, odl_GetLevelAssignments, odl_SetLevelAssignments, VT_BOOL)
DISP_PROPERTY_EX_ID(Task, "bLevelingCanSplit", 72, odl_GetLevelingCanSplit, odl_SetLevelingCanSplit, VT_BOOL)
DISP_PROPERTY_EX_ID(Task, "lLevelingDelay", 73, odl_GetLevelingDelay, odl_SetLevelingDelay, VT_I4)
DISP_PROPERTY_EX_ID(Task, "yLevelingDelayFormat", 74, odl_GetLevelingDelayFormat, odl_SetLevelingDelayFormat, VT_I4)
DISP_PROPERTY_EX_ID(Task, "dtPreLeveledStart", 75, odl_GetPreLeveledStart, odl_SetPreLeveledStart, VT_DATE)
DISP_PROPERTY_EX_ID(Task, "dtPreLeveledFinish", 76, odl_GetPreLeveledFinish, odl_SetPreLeveledFinish, VT_DATE)
DISP_PROPERTY_EX_ID(Task, "sHyperlink", 77, odl_GetHyperlink, odl_SetHyperlink, VT_BSTR)
DISP_PROPERTY_EX_ID(Task, "sHyperlinkAddress", 78, odl_GetHyperlinkAddress, odl_SetHyperlinkAddress, VT_BSTR)
DISP_PROPERTY_EX_ID(Task, "sHyperlinkSubAddress", 79, odl_GetHyperlinkSubAddress, odl_SetHyperlinkSubAddress, VT_BSTR)
DISP_PROPERTY_EX_ID(Task, "bIgnoreResourceCalendar", 80, odl_GetIgnoreResourceCalendar, odl_SetIgnoreResourceCalendar, VT_BOOL)
DISP_PROPERTY_EX_ID(Task, "sNotes", 81, odl_GetNotes, odl_SetNotes, VT_BSTR)
DISP_PROPERTY_EX_ID(Task, "bHideBar", 82, odl_GetHideBar, odl_SetHideBar, VT_BOOL)
DISP_PROPERTY_EX_ID(Task, "bRollup", 83, odl_GetRollup, odl_SetRollup, VT_BOOL)
DISP_PROPERTY_EX_ID(Task, "fBCWS", 84, odl_GetBCWS, odl_SetBCWS, VT_R4)
DISP_PROPERTY_EX_ID(Task, "fBCWP", 85, odl_GetBCWP, odl_SetBCWP, VT_R4)
DISP_PROPERTY_EX_ID(Task, "lPhysicalPercentComplete", 86, odl_GetPhysicalPercentComplete, odl_SetPhysicalPercentComplete, VT_I4)
DISP_PROPERTY_EX_ID(Task, "yEarnedValueMethod", 87, odl_GetEarnedValueMethod, odl_SetEarnedValueMethod, VT_I4)
DISP_PROPERTY_EX_ID(Task, "oPredecessorLink", 88, odl_GetPredecessorLink, SetNotSupported, VT_DISPATCH)
DISP_PROPERTY_EX_ID(Task, "oActualWorkProtected", 89, odl_GetActualWorkProtected, SetNotSupported, VT_DISPATCH)
DISP_PROPERTY_EX_ID(Task, "oActualOvertimeWorkProtected", 90, odl_GetActualOvertimeWorkProtected, SetNotSupported, VT_DISPATCH)
DISP_PROPERTY_EX_ID(Task, "oExtendedAttribute", 91, odl_GetExtendedAttribute, SetNotSupported, VT_DISPATCH)
DISP_PROPERTY_EX_ID(Task, "oBaseline", 92, odl_GetBaseline, SetNotSupported, VT_DISPATCH)
DISP_PROPERTY_EX_ID(Task, "oOutlineCode", 93, odl_GetOutlineCode, SetNotSupported, VT_DISPATCH)
DISP_PROPERTY_EX_ID(Task, "bIsPublished", 94, odl_GetIsPublished, odl_SetIsPublished, VT_BOOL)
DISP_PROPERTY_EX_ID(Task, "sStatusManager", 95, odl_GetStatusManager, odl_SetStatusManager, VT_BSTR)
DISP_PROPERTY_EX_ID(Task, "dtCommitmentStart", 96, odl_GetCommitmentStart, odl_SetCommitmentStart, VT_DATE)
DISP_PROPERTY_EX_ID(Task, "dtCommitmentFinish", 97, odl_GetCommitmentFinish, odl_SetCommitmentFinish, VT_DATE)
DISP_PROPERTY_EX_ID(Task, "yCommitmentType", 98, odl_GetCommitmentType, odl_SetCommitmentType, VT_I4)
DISP_PROPERTY_EX_ID(Task, "bActive", 99, odl_GetActive, odl_SetActive, VT_BOOL)
DISP_PROPERTY_EX_ID(Task, "bPinned", 100, odl_GetPinned, odl_SetPinned, VT_BOOL)
DISP_PROPERTY_EX_ID(Task, "sPinnedStart", 101, odl_GetPinnedStart, odl_SetPinnedStart, VT_BSTR)
DISP_PROPERTY_EX_ID(Task, "sPinnedFinish", 102, odl_GetPinnedFinish, odl_SetPinnedFinish, VT_BSTR)
DISP_PROPERTY_EX_ID(Task, "sPinnedDuration", 103, odl_GetPinnedDuration, odl_SetPinnedDuration, VT_BSTR)
DISP_PROPERTY_EX_ID(Task, "oTimephasedData", 104, odl_GetTimephasedData, SetNotSupported, VT_DISPATCH)
DISP_PROPERTY_EX_ID(Task, "Key", 105, odl_GetKey, odl_SetKey, VT_BSTR)
DISP_FUNCTION_ID(Task, "GetXML", 106, odl_GetXML, VT_BSTR, VTS_NONE)
DISP_FUNCTION_ID(Task, "SetXML", 107, odl_SetXML, VT_EMPTY, VTS_BSTR)
DISP_FUNCTION_ID(Task, "IsNull", 108, IsNull, VT_BOOL, VTS_NONE)
DISP_FUNCTION_ID(Task, "Initialize", 109, Initialize, VT_EMPTY, VTS_NONE)
END_DISPATCH_MAP()
...
BOOL Task::odl_GetDisplayAsSummary(void)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	return GetDisplayAsSummary();
}

BOOL Task::GetDisplayAsSummary(void)
{
	return (BOOL) mp_bDisplayAsSummary;
}

void Task::odl_SetDisplayAsSummary(BOOL newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	SetDisplayAsSummary((BOOL)newVal);
}

void Task::SetDisplayAsSummary(BOOL newVal)
{
	mp_bDisplayAsSummary = newVal;
}
...
LONG Task::odl_GetStartSlack(void)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	return GetStartSlack();
}

LONG Task::GetStartSlack(void)
{
	return (LONG) mp_lStartSlack;
}

void Task::odl_SetStartSlack(LONG newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	SetStartSlack((LONG)newVal);
}

void Task::SetStartSlack(LONG newVal)
{
	mp_lStartSlack = newVal;
}

LONG Task::odl_GetFinishSlack(void)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	return GetFinishSlack();
}

LONG Task::GetFinishSlack(void)
{
	return (LONG) mp_lFinishSlack;
}

void Task::odl_SetFinishSlack(LONG newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	SetFinishSlack((LONG)newVal);
}

void Task::SetFinishSlack(LONG newVal)
{
	mp_lFinishSlack = newVal;
}
...
BOOL Task::odl_GetActive(void)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	return GetActive();
}

BOOL Task::GetActive(void)
{
	return (BOOL) mp_bActive;
}

void Task::odl_SetActive(BOOL newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	SetActive((BOOL)newVal);
}

void Task::SetActive(BOOL newVal)
{
	mp_bActive = newVal;
}

BOOL Task::odl_GetPinned(void)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	return GetPinned();
}

BOOL Task::GetPinned(void)
{
	return (BOOL) mp_bPinned;
}

void Task::odl_SetPinned(BOOL newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	SetPinned((BOOL)newVal);
}

void Task::SetPinned(BOOL newVal)
{
	mp_bPinned = newVal;
}

BSTR Task::odl_GetPinnedStart(void)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	return GetPinnedStart().AllocSysString();
}

CString Task::GetPinnedStart(void)
{
	return (CString) mp_sPinnedStart;
}

void Task::odl_SetPinnedStart(LPCTSTR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	SetPinnedStart(newVal);
}

void Task::SetPinnedStart(CString newVal)
{
	mp_sPinnedStart = newVal;
}

BSTR Task::odl_GetPinnedFinish(void)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	return GetPinnedFinish().AllocSysString();
}

CString Task::GetPinnedFinish(void)
{
	return (CString) mp_sPinnedFinish;
}

void Task::odl_SetPinnedFinish(LPCTSTR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	SetPinnedFinish(newVal);
}

void Task::SetPinnedFinish(CString newVal)
{
	mp_sPinnedFinish = newVal;
}

BSTR Task::odl_GetPinnedDuration(void)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	return GetPinnedDuration().AllocSysString();
}

CString Task::GetPinnedDuration(void)
{
	return (CString) mp_sPinnedDuration;
}

void Task::odl_SetPinnedDuration(LPCTSTR newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	SetPinnedDuration(newVal);
}

void Task::SetPinnedDuration(CString newVal)
{
	mp_sPinnedDuration = newVal;
}
