...
public:
	...
	BSTR odl_GetSecondaryGuid(void);
	CString GetSecondaryGuid(void);
	void odl_SetSecondaryGuid(LPCTSTR newVal);
	void SetSecondaryGuid(CString newVal);
