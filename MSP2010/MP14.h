...
class MP14 : public CCmdTarget
{
	DECLARE_DYNCREATE(MP14)
...
public:
	...
	CString mp_sBaslineCalendar;
	BOOL mp_bNewTasksAreManual;
	BOOL mp_bUpdateManuallyScheduledTasksWhenEditingLinks;
	BOOL mp_bKeepTaskOnNearestWorkingTimeWhenMadeAutoScheduled;
	...
	BSTR odl_GetBaslineCalendar(void);
	CString GetBaslineCalendar(void);
	void odl_SetBaslineCalendar(LPCTSTR newVal);
	void SetBaslineCalendar(CString newVal);

	BOOL odl_GetNewTasksAreManual(void);
	BOOL GetNewTasksAreManual(void);
	void odl_SetNewTasksAreManual(BOOL newVal);
	void SetNewTasksAreManual(BOOL newVal);

	BOOL odl_GetUpdateManuallyScheduledTasksWhenEditingLinks(void);
	BOOL GetUpdateManuallyScheduledTasksWhenEditingLinks(void);
	void odl_SetUpdateManuallyScheduledTasksWhenEditingLinks(BOOL newVal);
	void SetUpdateManuallyScheduledTasksWhenEditingLinks(BOOL newVal);

	BOOL odl_GetKeepTaskOnNearestWorkingTimeWhenMadeAutoScheduled(void);
	BOOL GetKeepTaskOnNearestWorkingTimeWhenMadeAutoScheduled(void);
	void odl_SetKeepTaskOnNearestWorkingTimeWhenMadeAutoScheduled(BOOL newVal);
	void SetKeepTaskOnNearestWorkingTimeWhenMadeAutoScheduled(BOOL newVal);
