...
class AssignmentExtendedAttribute : public clsItemBase
{
	DECLARE_DYNCREATE(AssignmentExtendedAttribute)

public:

	AssignmentExtendedAttribute();
	virtual ~AssignmentExtendedAttribute();
...
protected:
	...
	DECLARE_MESSAGE_MAP()
	DECLARE_OLECREATE(AssignmentExtendedAttribute)
