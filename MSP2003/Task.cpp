...
//{C535E2D1-62BA-4A19-8C31-1F9464F46D1B}
static const IID IID_ITask = { 0xC535E2D1, 0x62BA, 0x4A19, { 0x8C, 0x31, 0x1F, 0x94, 0x64, 0xF4, 0x6D, 0x1B} };

//{39689AC8-E973-46C1-BA03-9965B5FBDC6F}
IMPLEMENT_OLECREATE_FLAGS(Task, "MSP2003.Task", afxRegApartmentThreading, 0x39689AC8, 0xE973, 0x46C1, 0xBA, 0x03, 0x99, 0x65, 0xB5, 0xFB, 0xDC, 0x6F)
...
DISP_PROPERTY_EX_ID(Task, "oTimephasedData", 91, odl_GetTimephasedData, SetNotSupported, VT_DISPATCH)
DISP_PROPERTY_EX_ID(Task, "Key", 92, odl_GetKey, odl_SetKey, VT_BSTR)
DISP_FUNCTION_ID(Task, "GetXML", 93, odl_GetXML, VT_BSTR, VTS_NONE)
DISP_FUNCTION_ID(Task, "SetXML", 94, odl_SetXML, VT_EMPTY, VTS_BSTR)
DISP_FUNCTION_ID(Task, "IsNull", 95, IsNull, VT_BOOL, VTS_NONE)
DISP_FUNCTION_ID(Task, "Initialize", 96, Initialize, VT_EMPTY, VTS_NONE)
END_DISPATCH_MAP()
...
void Task::SetType(E_TYPE_2 newVal)
{
	mp_yType = newVal;
}
