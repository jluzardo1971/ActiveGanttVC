...
//{9CB0ECEA-B69D-43CA-803F-F766BDD7A3B1}
static const IID IID_ITimephasedData = { 0x9CB0ECEA, 0xB69D, 0x43CA, { 0x80, 0x3F, 0xF7, 0x66, 0xBD, 0xD7, 0xA3, 0xB1} };

//{F8642958-EA4F-49E2-8D11-954D8AEDA5D5}
IMPLEMENT_OLECREATE_FLAGS(TimephasedData, "MSP2003.TimephasedData", afxRegApartmentThreading, 0xF8642958, 0xEA4F, 0x49E2, 0x8D, 0x11, 0x95, 0x4D, 0x8A, 0xED, 0xA5, 0xD5)
...
{
	mp_yType = T_5_ASSIGNMENT_REMAINING_WORK;
	mp_lUID = 0;
	mp_dtStart = (DATE) 0;
	mp_dtFinish = (DATE) 0;
	mp_yUnit = U_M;
...
E_TYPE_5 TimephasedData::GetType(void)
{
...
void TimephasedData::SetType(E_TYPE_5 newVal)
{
	mp_yType = newVal;
}
...
{
	BOOL bReturn = TRUE;
	if (mp_yType != T_5_ASSIGNMENT_REMAINING_WORK)
	{
		bReturn = FALSE;
	}
	if (mp_lUID != 0)
