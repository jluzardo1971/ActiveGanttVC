...
//{9E497F8F-7C09-425C-ABFF-2B671A8C2F3C}
static const IID IID_IResource = { 0x9E497F8F, 0x7C09, 0x425C, { 0xAB, 0xFF, 0x2B, 0x67, 0x1A, 0x8C, 0x2F, 0x3C} };

//{C7973CD3-B77C-4B52-B13F-AE39984AB099}
IMPLEMENT_OLECREATE_FLAGS(Resource, "MSP2003.Resource", afxRegApartmentThreading, 0xC7973CD3, 0xB77C, 0x4B52, 0xB1, 0x3F, 0xAE, 0x39, 0x98, 0x4A, 0xB0, 0x99)
...
DISP_PROPERTY_EX_ID(Resource, "oAvailabilityPeriods", 65, odl_GetAvailabilityPeriods, SetNotSupported, VT_DISPATCH)
DISP_PROPERTY_EX_ID(Resource, "oRates", 66, odl_GetRates, SetNotSupported, VT_DISPATCH)
DISP_PROPERTY_EX_ID(Resource, "oTimephasedData", 67, odl_GetTimephasedData, SetNotSupported, VT_DISPATCH)
DISP_PROPERTY_EX_ID(Resource, "Key", 68, odl_GetKey, odl_SetKey, VT_BSTR)
DISP_FUNCTION_ID(Resource, "GetXML", 69, odl_GetXML, VT_BSTR, VTS_NONE)
DISP_FUNCTION_ID(Resource, "SetXML", 70, odl_SetXML, VT_EMPTY, VTS_BSTR)
DISP_FUNCTION_ID(Resource, "IsNull", 71, IsNull, VT_BOOL, VTS_NONE)
DISP_FUNCTION_ID(Resource, "Initialize", 72, Initialize, VT_EMPTY, VTS_NONE)
END_DISPATCH_MAP()
...
E_TYPE_4 Resource::GetType(void)
{
...
void Resource::SetType(E_TYPE_4 newVal)
{
	mp_yType = newVal;
}
