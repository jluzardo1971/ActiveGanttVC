...
class ExtendedAttributes : public CCmdTarget
{
	DECLARE_DYNCREATE(ExtendedAttributes)
...
public:
	...
	ExtendedAttribute* Item(CString Index);

	IDispatch* odl_Add(void);
	ExtendedAttribute* Add(void);
...
protected:
	...
	DECLARE_MESSAGE_MAP()
	DECLARE_OLECREATE(ExtendedAttributes)
