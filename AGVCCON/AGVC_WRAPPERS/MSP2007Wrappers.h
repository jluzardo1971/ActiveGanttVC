...
class CMP12 : public COleDispatchDriver
{
// Constructors
public:
	CMP12() {}	
	CMP12(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CMP12(const CMP12& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
class CMSP2007Ctl : public CWnd
{
protected:
	DECLARE_DYNCREATE(CMSP2007Ctl)
public:
	CLSID const& GetClsid()
	{
		static CLSID const clsid = { 0x3366D66A, 0x4F20, 0x40C1, { 0x95, 0x80, 0x51, 0x31, 0xAB, 0x08, 0xE2, 0x18} };
		return clsid;
	}
