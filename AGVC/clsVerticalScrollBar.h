...
class clsVScrollBarTemplate;

class clsVerticalScrollBar : public CCmdTarget
{
	DECLARE_DYNCREATE(clsVerticalScrollBar)
	clsVerticalScrollBar();

public:
	CActiveGanttVCCtl* mp_oControl;

	clsVerticalScrollBar(CActiveGanttVCCtl* oControl);
	virtual ~clsVerticalScrollBar();
...
public:
	...
	clsVScrollBarTemplate* mp_oScrollBar;			
...
public:
	...
	clsVScrollBarTemplate* GetScrollBar(void);
...
public:
	...
	void Reset(void);
	void Position(void);
	void oVScrollBar_ValueChanged(LONG Offset);

protected:
	DECLARE_DISPATCH_MAP()
	DECLARE_MESSAGE_MAP()
	DECLARE_OLECREATE(clsVerticalScrollBar)
