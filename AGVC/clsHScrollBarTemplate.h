...
class clsHScrollBarTemplate : public CCmdTarget
{
	DECLARE_DYNCREATE(clsHScrollBarTemplate)
	clsHScrollBarTemplate();
...
public:
	...
	clsHScrollBarTemplate(CActiveGanttVCCtl* oControl);
	virtual ~clsHScrollBarTemplate();
...
public:
	...
	void Clear(void);
	void Clone(clsHScrollBarTemplate* oClone);
...
public:
	...
	void SmallChangeLeft(void);
	void SmallChangeRight(void);
	void LargeChangeLeft(void);
	void LargeChangeRight(void);
	void mp_ValueChanged(void);
	void mp_oTimer_Tick(void);
	void CalculateH(void);
	LONG InvCalculateH(LONG X);

protected:
	DECLARE_DISPATCH_MAP()
	DECLARE_MESSAGE_MAP()
	DECLARE_OLECREATE(clsHScrollBarTemplate)
